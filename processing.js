...
function predictImage() {
    ...
    //change the colur to single colour i.e. GRAYSCALE
    cv.cvtColor(image, image, cv.COLOR_RGBA2GRAY, 0);

    //change the colour to white for presentation
    ...
    //roi = region of interest - Cropping Image into rectangle
